...
abbrev SameAction (r₁ r₂ : Rule Fact Action) : Prop :=
...
-/
def MoreSpecific (r₁ r₂ : Rule Fact Action) : Prop :=
...
-/
def Shadowed (R : List (Rule Fact Action)) (F : FactSet Fact) (r₁ : Rule Fact Action) : Prop :=
  r₁ ∈ R ∧
  Fires r₁ F ∧
  ∃ r₂, r₂ ∈ R ∧
    Fires r₂ F ∧
