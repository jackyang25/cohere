...
def ConflictingRules (r₁ r₂ : Rule) : Prop :=
...
-/
def IndependentPremises (r₁ r₂ : Rule) : Prop :=
...
-/
def OverlapFacts (r₁ r₂ : Rule) : FactSet :=
...
-/
def GuidedConflict (r₁ r₂ : Rule) : Prop :=
